...
public sealed class EvaluatedProperties
{
    ...
    /// <summary>
    /// Microsoft.Testing.Platform's marker for a runner project, set in place of
    /// <see cref="IsTestProject"/>. MTP imports its targets from a restored
    /// package, so the value exists only once the project has been restored.
    /// </summary>
